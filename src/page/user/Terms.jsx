    ...
    <div className="terms-and-policies py-10">
      ...
      <div className="container lg:max-w-full">
        ...
        <div className="t-n-p-content flex items-start">
          <div className="t-n-p-nav w-[300px] max-h-[90svh] overflow-auto sticky top-[20px] lg:max-h-none p-4 z-[51]">
            <CloseIcon
          ...
          <div className="t-n-p-text w-[calc(100%-300px)] inline-block pl-[40px] pb-[40vh] lg:w-full lg:pl-0">
            <div className="user-terms">
              ...
              >
                ...
                <div className="py-8 px-6 sm:py-4 sm:px-3">
            ...
            <div className="general-terms">
              ...
              >
                ...
                <p className="py-8 px-6 sm:py-4 sm:px-3 sm:text-[12px]">
              ...
              >
                ...
                <div className="py-8 px-6 sm:py-4 sm:px-3 sm:text-[12px]">
