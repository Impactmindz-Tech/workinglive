  ...
  return (
    <>
      ...
      <div className="overflow-hidden">
        ...
        >
          <div className="my-6 grid grid-cols-4 lg:grid-cols-2 sm:grid-cols-1 xl:grid-cols-2 gap-4 lg:my-2 hidden-scrollbar overflow-hidden p-4">
            {data.length !== 0 ? (
              data.map((product) => (
                <HomeExperienceList key={product._id} product={product} />
              ))
            ) : !loading && !error ? (
