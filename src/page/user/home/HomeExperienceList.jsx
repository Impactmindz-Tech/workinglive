...
const HomeExperienceList = ({ product }) => {
  ...
  return (
    <>
      ...
      <Link to={"/auth/login"}>
        <div className="max-w-sm rounded overflow-hidden shadow-lg sm:m-auto h-full relative">
          {" "}
          <SwiperSlider
            setheight={true}
          ...
          <div className="px-5 py-4 sm:px-3">
            ...
            <div className="flex gap-2 items-center justify-between">
              <p className="text-gray-700 text-base w-[60%] lg:w-[58%] font-medium sm:text-xs">
