  ...
  const handlecheckout = async () => {
    if (selectedMethod === "stripe") {
      ...
      let body = {
        ...
        price: (total + parseFloat(bookingDetails?.data?.booking?.Adminfee)).toFixed(2),
            ...
            <div className="flex BoxShadowLessRounded m-auto w-[50%] md:w-full my-5 bg-boxFill-900">
              <div className="py-2 px-4 w-full">
                ...
                <div className="text flex justify-between py-1 sm:text-sm">
                  ...
                  <div className="font-medium">
                    {getCurrencySymbol()}
                    {bookingDetails?.data?.booking?.Adminfee}
                  </div>
                </div>
                ...
                <div className="total borderTop mt-2 py-2">
                  <div className="text flex justify-between py-1">
                    ...
                    <div className="font-bold">
                      {getCurrencySymbol()}
                      {(total + parseFloat(bookingDetails?.data?.booking?.Adminfee)).toFixed(2)}
                    </div>
                  </div>
                </div>
              </div>
