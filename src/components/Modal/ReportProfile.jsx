      ...
      <div className="fixed flex items-end justify-center inset-0 bg-black bg-opacity-50 z-[99]">
        ...
        >
          ...
          <div className="py-4 sm:py-2">
            <div className="mb-4">
              <div className="flex items-center justify-between my-4 cardShadow p-3 sm:mt-0">
                <label htmlFor="Scamming" className="sm:w-[80%] sm:text-sm">
              ...
              <div className="flex items-start justify-between my-4 cardShadow p-3 sm:mt-0">
                <label htmlFor="Offensive" className="sm:w-[80%] sm:text-sm">
