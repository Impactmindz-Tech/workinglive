      ...
      <div className="BoxShadowLessRounded pb-2">
        <div className="flex gap-4 p-4 sm:flex-wrap sm:gap-0 sm:p-2">
          ...
          <div className="[70%] sm:pl-3">
            <h2 className="text-lg font-bold sm:text-sm first-letter-capital">
              {item?.experienceName || "Experience Name"},{" "}
              {item?.country || "Country"}
            </h2>

            <div className="flex justify-between items-center gap-2 text-xs py-[2px]">
              <div className="icon">
        ...
        {role === "avatar" && (
          <div className="flex justify-between m-auto w-[94%] py-2 text-grey-800 sm:w-full sm:px-2 sm:py-0">
            <button className="border bg-[#ffe5e7] border-[#ffe5e7] text-[#FF3544] font-semibold py-2 rounded w-[100%] sm:text-xs">
